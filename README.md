...
La aplicación toma el canal de aceleración disponible (priorizando `az_g`), filtra filas inválidas y utiliza la tabla de mapeo incorporada en la interfaz para renombrar cada `sensor_id` al tirante configurado.

### Configuración de mapeo sin JSON

En el Paso 2 de la interfaz encontrarás una tabla con los sensores preconfigurados (`3808`, `3810`, `10589`, `10598`, `10603`, `14030`, `14031`). Para cada uno puedes:

- **Activar/Desactivar** si el sensor estará presente en los archivos a monitorear.
- **Tirante**: nombre amigable que aparecerá en las tablas y gráficas.
- **f₀ propuesta (Hz)**: frecuencia fundamental sugerida para el refinamiento del análisis.
- **Ke (Ton·s)**: coeficiente de rigidez utilizado para estimar la tensión.

Al guardar los cambios, los archivos como `sensor_10603_acceleration_20251114_162708_000-002min.csv` se procesarán automáticamente usando el nombre de tirante y los parámetros que definiste, sin necesidad de escribir JSON.
